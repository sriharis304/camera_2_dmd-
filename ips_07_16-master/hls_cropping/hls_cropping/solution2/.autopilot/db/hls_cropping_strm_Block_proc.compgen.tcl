...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { src_TREADY { O 1 bit } src_TDEST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dst_V_V_TDATA { O 16 vector } dst_V_V_TVALID { O 1 bit } dst_V_V_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'dst_V_V'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sof_sig \
    op interface \
    ports { sof_sig { O 1 vector } sof_sig_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_dst_valid \
    op interface \
    ports { dst_valid { O 1 vector } dst_valid_ap_vld { O 1 bit } } \
} "
}
