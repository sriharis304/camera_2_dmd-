...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("dst_valid", 1, hls_out, 8, "ap_vld", "out_data", 1),
	Port_Property("sof_sig", 1, hls_out, 9, "ap_vld", "out_data", 1),
	...
	Port_Property("sof_sig_ap_vld", 1, hls_out, 9, "ap_vld", "out_vld", 1),
	Port_Property("dst_valid_ap_vld", 1, hls_out, 8, "ap_vld", "out_vld", 1),
};
