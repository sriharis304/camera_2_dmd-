...
set C_modelArgList { 
	...
	{ dst_valid_V int 1 regular {pointer 1}  }
	{ sof_sig_V int 1 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "src_V_data_V", "interface" : "axis", "bitwidth" : 8,"bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "src.V.data.V","cData": "uint8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "dst_valid_V", "interface" : "wire", "bitwidth" : 1,"bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "dst_valid.V","cData": "uint1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "sof_sig_V", "interface" : "wire", "bitwidth" : 1,"bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "sof_sig.V","cData": "uint1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ dst_valid_V sc_out sc_lv 1 signal 8 } 
	{ dst_valid_V_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ sof_sig_V sc_out sc_lv 1 signal 9 } 
	{ sof_sig_V_ap_vld sc_out sc_logic 1 outvld 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_valid_V", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "dst_valid_V", "role": "default" }} , 
 	{ "name": "dst_valid_V_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "dst_valid_V", "role": "ap_vld" }} , 
 	{ "name": "sof_sig_V", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "sof_sig_V", "role": "default" }} , 
 	{ "name": "sof_sig_V_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sof_sig_V", "role": "ap_vld" }}  ]}
set Spec2ImplPortList { 
	...
	dst_valid_V { ap_vld {  { dst_valid_V out_data 1 1 }  { dst_valid_V_ap_vld out_vld 1 1 } } }
	sof_sig_V { ap_vld {  { sof_sig_V out_data 1 1 }  { sof_sig_V_ap_vld out_vld 1 1 } } }
}
